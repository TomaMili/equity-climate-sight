...
export const MapContainer = ({ onRegionClick, selectedRegion, mapboxToken, onTokenError, onDataLoaded, year = 2024, filters, onFilteredCountChange, currentCountry = null, onExitDrillDown }: MapContainerProps) => {
  ...
  return (
    <div className=" w-full h-full">
      ...
      {currentCountry && onExitDrillDown && (
        <div className="absolute top-4 left-4 z-10">
          <button
            onClick={onExitDrillDown}
            className="px-4 py-2.5 bg-background/95 backdrop-blur-sm border-2 border-primary/30 rounded-lg shadow-lg hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all flex items-center gap-2 text-sm font-semibold"
          >
            <svg
